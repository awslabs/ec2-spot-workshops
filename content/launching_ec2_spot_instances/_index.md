...
> $ aws ec2 create-launch-template --launch-template-name TemplateForSpot --version-description TemplateForSpotVersion1 --launch-template-data "{\\"NetworkInterfaces\\":\[{\\"DeviceIndex\\":0,\\"SubnetId\\":\\"***subnet-05ef7d72***\\"}\],\\"ImageId\\":\\"***ami-97785bed***\\",\\"InstanceType\\":\\"***c4.large***\\",\\"TagSpecifications\\":\[{\\"ResourceType\\":\\"instance\\",\\"Tags\\":\[
{\\"Key\\":\\"Name\\",\\"Value\\":\\"***EC2SpotImmersionDay***\\"}\]}\]}"
...
{{% notice info %}}
Note the **LaunchTemplateId** (eg. "lt-0abcd290751193123") or 
...
1. For **Tell us your application or task need**, choose 
**Flexible workloads**.
