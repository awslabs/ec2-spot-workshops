...
- **tags**: the tags that will be applied to EC2 instances launched within this compute environment.  These tags can be used to filter EC2 instances for various things like cost or experiments using Fault Injection Simulator(FIS).
