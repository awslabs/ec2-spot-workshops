...
[amazon-ec2-spot-cicd-workshop.yaml](/config/amazon-ec2-spot-cicd-workshop/amazon-ec2-spot-cicd-workshop.yaml)
...
3. At the Select Template screen, select the **Specify an Amazon S3 template URL** radio button and type in [amazon-ec2-spot-cicd-workshop.yaml](/config/amazon-ec2-spot-cicd-workshop/amazon-ec2-spot-cicd-workshop.yaml) as the URL, then click on the **Next** button;
